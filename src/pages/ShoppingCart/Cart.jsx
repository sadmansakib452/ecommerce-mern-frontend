              ...
              <div className="cart_listing" key={product._id}>
                ...
                <div>
                  <div className="addCount-button">
                    <img
                      src="https://ecommerce-files-347.s3.ap-southeast-1.amazonaws.com/icons/minus-icon.png"
                      alt=""
                      onClick={(e) => quantityHandler(product, product.qty - 1)}
                    />
                    {product.qty}
                    <img
                      src="https://ecommerce-files-347.s3.ap-southeast-1.amazonaws.com/icons/plus-icon.png"
                      alt=""
                      onClick={(e) => quantityHandler(product, product.qty + 1)}
                    />
                  </div>
                ...
                <h2 className="cart_listing__text">
                  BDT {((product.price * product.qty)).toFixed(2)}
                </h2>
                <h2
